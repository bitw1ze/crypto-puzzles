...
# borrowed from git://github.com/ajalt/python-sha1.git
...
def sha1(message, seed=None, pad=True):
    ...
    # my modification
    # If there is a seed, use it and do not pad our input
    if seed:
        h0, h1, h2, h3, h4 = (struct.unpack('>5I', seed))
    else:
        h0, h1, h2, h3, h4, = (
